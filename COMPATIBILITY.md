...
Hosts own workspace and project loading, establishment of the authoritative authored-syntax-tree set, generator package discovery and admission, orchestration, and output destinations. Adapters own source-framework semantics and contribute neutral facts, evidence, provenance, and diagnostics. Screenplay Generation owns deterministic resolution, lowering to the Screenplay AST, canonical text, and compiler verification.
